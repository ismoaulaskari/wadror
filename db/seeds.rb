...
b4 = Brewery.create name:"Hartwall", year:1950
...
bc2 = BeerClub.create name:"Hyvän oluen ystävät", year:2000, city:"Helsinnki"
...
Brewery.all.each do |b|
  ...
  (1..n).each do |i|
    beer = Beer.create! name:"beer #{b.id} -- #{i}", style:"Lager", brewery:b
    b.beers << beer
  end
end
